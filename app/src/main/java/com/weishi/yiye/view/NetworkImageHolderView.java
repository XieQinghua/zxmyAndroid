 ...
 * 网络图片加载例子
 */
public class NetworkImageHolderView implements Holder<AdvDatasBean.DataBean.BannerDataBean> {
    ...
    @Override
    public void UpdateUI(Context context, final int position, AdvDatasBean.DataBean.BannerDataBean data) {
        try {
